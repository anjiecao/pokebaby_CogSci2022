...
sim_res <- readRDS(here("sim_res/02_param_search_sim.RDS"))
kl_sim_res <- readRDS(here("sim_res/KL_tidy_sim.RDS"))
s_sim_res <- readRDS(here("sim_res/02_Surprisal_tidy_sim.RDS"))
...
scaled_s_model_res <- scale_model_results(b_res_print, s_res_print, best_params = "ae_1_be_10_ap_1_bp_4_np_0.07_wEIG_8")
