...
# maybe we don't want to scale the basic model either, because sd = 0? or do we just apply a constant to match the mean? 
scaled_basic_sim_b_res <- scale_basic_model(b_res_print, basic_res_print, best_params = "ap_1_bp_2")
...
scaled_basic_sim_b_res %>% 
  ...
  geom_point() + 
  geom_line() + 
  facet_grid(im_type_print~sequence_scheme) + 
