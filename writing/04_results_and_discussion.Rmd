...
```{r basic_result, echo = FALSE, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=3.8, fig.height=3.8, set.cap.width=T, num.cols.cap=1, fig.cap = "Results from the discrete time model. The top panels show the trajectories of KL under different sequences, and the bottom panels showw the trajectoreis of surprisal."}
